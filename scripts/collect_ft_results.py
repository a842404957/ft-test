...
def read_simulation_summary(summary_csv: Path):
    ...
    return {
        ...
        'affected_weight_count': metric('Reliability', 'Affected Weight Count'),
        'stuck_at_zero_count': metric('Reliability', 'Stuck At Zero Count'),
        'stuck_at_one_count': metric('Reliability', 'Stuck At One Count'),
        ...
        'level1_failed_singleton': metric('Reliability', 'Level1 Failed Singleton'),
        'level1_zero_scale_failed': metric('Reliability', 'Level1 Zero Scale Failed'),
        'repair_mode': repair_mode,
        'level1_selection_mode': values.get(('Level1Selection', 'level1_selection_mode'), ''),
        'best_pair_used': metric('Level1Selection', 'best_pair_used'),
        'weighted_average_used': metric('Level1Selection', 'weighted_average_used'),
        'fallback_to_default': metric('Level1Selection', 'fallback_to_default'),
        'fallback_reason': values.get(('Level1Selection', 'fallback_reason'), ''),
        'default_expected_error': metric('Level1Selection', 'default_expected_error'),
        'selected_expected_error': metric('Level1Selection', 'selected_expected_error'),
        'expected_error_improvement': metric('Level1Selection', 'expected_error_improvement'),
        'actual_before_error': metric('Level1Selection', 'actual_before_error'),
        'actual_after_error': metric('Level1Selection', 'actual_after_error'),
        'actual_error_improvement': metric('Level1Selection', 'actual_error_improvement'),
        'expected_actual_corr': metric('Level1Selection', 'expected_actual_corr'),
...
def aggregate_evidence_reports(evidence_root: Path, output_dir: Path = None):
    ...
    fieldnames = [
        ...
        'affected_weight_count', 'stuck_at_zero_count', 'stuck_at_one_count',
        'repair_mode', 'level1_corrections', 'level2_corrections', 'level3_corrections',
        'level1_failed_singleton', 'level1_zero_scale_failed', 'repair_attempted', 'repair_effective_improved',
